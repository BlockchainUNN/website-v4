...
export default function HackerTeam() {
    ...
    return <div className="bg-[url('/assets/events/hero_bg.jpg')] bg-cover bg-center w-full h-full pt-16 space-y-12" >
        <section className="w-1/3 mx-auto flex items-center justify-center gap-3">
        ...
        <section className="w-10/12 lg:h-[30vh] mx-auto bg-white outline-5 outline-black p-10 flex flex-col items-center justify">
            <div className="w-10/12 flex items-center justify-center gap-10 mx-auto">
                <StackGridButton
                    text="Create Team"
                    variant="navigation"
            ...
            <div className="p-5 sm:p-8 relative w-10/12">
                <form onSubmit={handleSubmit(onSubmit)} className="space-y-4">
                    <div className="flex items-center gap-5 border-3 border-[#02270C] py-3 px-2">
                        <div>
                            <UsersRoundIcon className="text-[#7A7A7A] size-8" />
                        </div>
                        <input
                            {...register("teamName")}
                            placeholder={activeTab == "create" ? "Enter your team name" : "Enter your team code"}
                            className="focus:outline-none font-medium text-black h-12 text-2xl"
                        />
                        {errors.teamName && (
