...
export default function HackerProjects() {
  ...
  return (
    <div className="bg-[url('/assets/events/hero_bg.jpg')] bg-cover bg-center w-full lg:w-[65vw] h-full pt-16 space-y-12 mx-auto">
      <section className="w-3/5 lg:w-1/3 mx-auto flex items-center justify-center gap-5">
