    ...
    return <div style={{ backgroundImage: "url(/assets/events/stats_bg.jpg)", fontFamily: "var(--font-hanken)" }} className="relative w-full h-screen bg-cover bg-center flex items-start justify-center pt-20  lg:p-20">
        ...
        <div className="flex flex-col items-center justify-start z-10 text-white h-full gap-10">
            ...
            <section className="text-center space-y-4 mt-10 lg:mt-0">
                <p className="text-4xl lg:text-6xl font-bold">Ready to Hack, <span className="text-green-500">{user.name}?</span></p>
                <p className="text-2xl lg:text-4xl">You registered on the {user.date}</p>
            </section>
